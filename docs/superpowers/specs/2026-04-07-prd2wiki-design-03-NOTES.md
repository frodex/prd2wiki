...
- Patterns emerge across projects (e.g., "every project that uses JWT encounters the same session timeout issue") OR WE ALREADY BUILT THIS FOR PROJECT "Y" OR WE SOLVED THIS IN OUR PROJECT "Q" DESIGN 
