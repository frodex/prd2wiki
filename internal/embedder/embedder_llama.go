...
type EmbedderConfig struct {
	Type          string `yaml:"type"`             // "llama_cpp", "openai", "noop"
...
func NewLlamaCppEmbedder(cfg EmbedderConfig) *LlamaCppEmbedder {
	if cfg.BatchSize <= 0 {
		cfg.BatchSize = 64
	}
...
func (e *LlamaCppEmbedder) Embed(ctx context.Context, text, language string) ([]float32, error) {
...
func (e *LlamaCppEmbedder) EmbedQuery(ctx context.Context, query, language string) ([]float32, error) {
...
func (e *LlamaCppEmbedder) EmbedBatch(ctx context.Context, texts []string, language string) ([][]float32, error) {
	if len(texts) == 0 {
		return [][]float32{}, nil
	}
...
func (e *LlamaCppEmbedder) HealthCheck(ctx context.Context) error {
